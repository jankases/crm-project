...
window.loadDropdowns = async function(forceReload) {
  ...
  try {
    ...
    // 🌟 FIX: โหลดรายการ Purpose ทั้งหมดจากหมวด Purpose / CallPurpose
...
// ==========================================
// 📝 10. FORM ACTIONS & OPEN EDIT VISIT VIEW
// ==========================================
window.openEditVisitView = async function(visitId) {
  ...
  // 🌟 FIX PURPOSE: ตั้งค่า Purpose แบบสอดคล้อง 100% ทั้งแบบ ID และ Text
  ...
  if (targetPurpose && window.tomSelectPurposeInstance) {
      ...
      // ถ้าค้นหาด้วย Value/Index_ID โดยตรงไม่เจอ ให้ลองเทียบเคียงจาก Cache
